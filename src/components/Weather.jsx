  ...
  return (
    ...
    <h1 className="text-4xl mb-6 text-yellow-600">☁️ Weather App ☀️</h1>
      ...
      <div className="md:mt-16 mt-6 flex items-center justify-center">
        <h1 className=" text-4xl font-bold text-rose-500 md:mb-0 mb-6">Weather For {city}</h1>
      </div>
      <div className="md:grid md:grid-cols-3 flex flex-col items-center md:mt-16 md:mx-32">
        <div className="md:w-[500px] h-[280px] w-[360px] md:mb-0 mb-8 bg-gray-100 border-gray-200 border-2">
        ...
        <div className="md:w-[500px] md:h-[280px] w-[360px]  md:mb-0 mb-8 bg-gray-100 border-gray-200 border-2">
